// Ported from teable packages/core/src/models/field/colors.ts (pure data).
// 10 color families × 5 shades (Light2, Light1, Bright, Base, Dark1) = 50 colors.
...
export const rgbTuplesByColor: Record<Colors, [number, number, number]> = {
